				...
				<form name="updateForm" role="form" method="post" action="/board/update">
					...
					<table>
						<tbody>
							<tr>
								<td>
									<label for="title">제목</label><input type="text" id="title" name="title" value="${view.title}"/>
								</td>
							</tr>	
							<tr>
								<td>
									<label for="content">내용</label><textarea id="content" name="content"><c:out value="${view.content}" /></textarea>
								</td>
							</tr>
							<tr>
								<td>
